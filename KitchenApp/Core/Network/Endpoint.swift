...
enum Endpoint {
    ...
    // Comments
    case comments(recipeId: UUID, page: Int, perPage: Int)
    case postComment(recipeId: UUID)
    ...
    var path: String {
        ...
        case .comments(let rid, _, _):          return "/recipes/\(rid)/comments"
        case .postComment(let rid):             return "/recipes/\(rid)/comments"
